	...
	var PercentageSymbol = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var iconContainerStyle = (_iconContainerStyle = {
	      ...
	      overflow: 'hidden',
	      top: 0
	    }, _defineProperty(_iconContainerStyle, this.props.direction === 'rtl' ? 'right' : 'left', 0), _defineProperty(_iconContainerStyle, 'width', this.props.percent !== undefined ? this.props.percent + '%' : 'auto'), _defineProperty(_iconContainerStyle, 'transition', this.props.animate === true ? ( this.props.transition !== undefined ? this.props.transition : 'width 150ms linear' ) : 'none' ), _iconContainerStyle);
	    var style = {
